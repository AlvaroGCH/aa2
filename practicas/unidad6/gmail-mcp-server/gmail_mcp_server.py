...
def _build_profile_string() -> str:
    """Función interna que obtiene y formatea el perfil del usuario."""
    service = get_gmail_service()
...
def get_profile() -> str:
    ...
    return _build_profile_string()


@mcp.tool()
def get_profile_tool() -> str:
    """Obtiene el perfil del usuario de Gmail (email, total de mensajes e hilos)."""
    return _build_profile_string()
